        ...
        <header>
            <nav class="navBar">
                ...
                <ul class="options">    
                    ...
                    <li><a style="color: #000000;" href="../Views/location.php">Ubicación</a></li>
                </ul>
            ...
            <h1 align="center">Ubicación</h1>
                <div class="imgContainer">
                    <div class="imgContent">
                        <img class="map" src="../Images/maps.png" alt="">
                    </div>
                </div>
                <div class="locationInfoContainer">
                    <div class="locationInfo">
                        <p>Avenida Tabachines Zapopan, Jalisco. Código postal: 45188</p>
                    </div>
                </div>
        </main>
    </div>
