...
<head>
    ...
    <link rel="stylesheet" href="../Styles/productsUser.css">
</head>
<body>
        ...
        <header>
            <nav class="navBar">
                ...
                <ul class="options">    
                    ...
                    <li><a style="color: #000000;" href="../Views/products.php">Productos</a></li>
                ...
                if ($resultado->num_rows > 0) {
                    ...
                    while ($fila = $resultado->fetch_assoc()) {
                        echo '<div class="productContent">';
                            echo '<div class="productImage" onclick="window.location.href=\'product.php?id=' . $fila['id_product'] . '\'">';
                            ...
                            echo '<div class="productInfo">';
                                ...
                                echo '<a class="openProduct" href="car.php?action=add&id=' . $fila["id_product"] . '">Añadir al carrito</a>';
                            echo '</div>';
                        echo '</div>';
                    }
                } else {
